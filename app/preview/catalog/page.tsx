      ...
      <div className="space-y-6">
        ...
        <div className="bg-amber-50 border border-amber-200 rounded-lg p-4">
          <div className="flex items-center justify-between">
            <div>
              <h3 className="font-medium text-amber-800">🖼️ Preview Mode - Real Image Catalog</h3>
              <p className="text-sm text-amber-700">Browse actual AI-generated images with full search, filtering, and delete functionality!</p>
            </div>
            <Link href="/preview">
        ...
        {/* Header */}
        <div>
          <h1 className="text-3xl font-bold text-gray-900">Portrait Catalog</h1>
