  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await fetch('/api/referrals', {
        ...
        body: JSON.stringify({
          client_first_name: formData.clientFirstName.trim(),
          client_last_name: formData.clientLastName.trim(),
        ...
        <div className="max-w-2xl mx-auto space-y-6">
          ...
          <Card className="text-center border-green-200">
            <CardHeader>
              ...
              <CardTitle className="text-2xl text-green-900">Referral Created Successfully!</CardTitle>
              <CardDescription>
                QR code generated for {formData.clientFirstName} {formData.clientLastName}. Expires on {getExpirationDate()}
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              {/* QR Code Display */}
              <div className="bg-white p-6 rounded-lg border-2 border-dashed border-green-300 inline-block">
              ...
              <div className="bg-green-50 rounded-lg p-4">
                <h3 className="font-medium text-green-900 mb-2">Client Information</h3>
                <div className="text-sm text-green-700 space-y-1">
                  <p>
                    <strong>Name:</strong> {formData.clientFirstName} {formData.clientLastName}
                  </p>
                  <p>
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                <Button onClick={handleCopyLink} variant="outline" className="flex-1 border-green-300 text-green-700 hover:bg-green-50">
                  {copied ? (
                    <>
                ...
                <Button onClick={handleDownloadQR} variant="outline" className="flex-1 border-green-300 text-green-700 hover:bg-green-50">
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                <Button
                  onClick={() => {
                    ...
                    setFormData({ clientFirstName: "", clientLastName: "", email: "", phone: "", notes: "", petName: "", petBreedId: "", petCoatId: "" })
                    setReferral(null)
                  }}
      ...
      <div className="max-w-2xl mx-auto space-y-6">
        ...
        <Card className="border-green-200">
          <CardHeader className="text-center">
            ...
            <CardTitle className="text-2xl text-green-900">Create New Referral</CardTitle>
          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    ...
                    />
                    {errors.clientFirstName && <p className="text-sm text-red-600">{errors.clientFirstName}</p>}
                  </div>
                  <div className="space-y-2">
                    ...
                    />
                    {errors.clientLastName && <p className="text-sm text-red-600">{errors.clientLastName}</p>}
                  </div>
                </div>
              ...
              <div className="space-y-4">
                <h3 className="font-semibold text-lg text-green-900">Pet Information (Optional)</h3>
                <p className="text-sm text-green-700">Add pet details to help personalize their portrait experience</p>
