...
export default function EditProductPage() {
  ...
  const loadData = async () => {
    try {
      ...
      const [productResult, mediaResult, formatsResult] = await Promise.all([
      ...
      setFormData({
        medium_id: productResult.medium.id,
        format_id: productResult.format.id,
        description: productResult.description || '',
        size_name: productResult.size_name || '',
        size_code: productResult.size_code || '',
        width_cm: productResult.width_cm || '',
        height_cm: productResult.height_cm || '',
        width_inches: productResult.width_inches || '',
      ...
      // Load pricing for existing Gelato SKU if present
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await supabaseService.updateProduct(productId, formData);
  ...
  // Gelato integration functions (same as new product page)
  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      ...
      <div className="flex items-center space-x-4">
        ...
        <div>
          ...
          <p className="text-gray-600">
            {product && `Editing: ${product.name || product.sku}`}
          </p>
        </div>
      </div>
      ...
      {/* Gelato Product Search Modal (same as new product page) */}
      {showGelatoSearch && (
