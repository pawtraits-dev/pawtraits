...
export default function PartnerImageDetailPage() {
  ...
  const loadData = async () => {
    try {
      ...
      const [imageResult, productsData, pricingData, partnerData] = await Promise.all([
        supabaseService.getImageById(imageId),
        supabaseService.getPublicProducts(),
        supabaseService.getPublicProductPricing(),
        supabaseService.getCurrentPartner().catch(() => null)
      ]);
      ...
      if (currentUser?.email) {
        await checkIfPurchased(currentUser.email);
      }
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-green-50 to-emerald-50 p-8">
        <div className="max-w-4xl mx-auto text-center py-12">
          ...
          <Button onClick={() => router.push('/partners/shop')} variant="outline">
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-50 to-emerald-50 p-4 md:p-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-6">
          <Button
            onClick={() => router.push('/partners/shop')}
            variant="outline"
