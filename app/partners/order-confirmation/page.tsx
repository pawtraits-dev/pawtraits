...
import { CheckCircle, Package, Truck, Mail, ArrowRight, Loader2, Users, Star } from "lucide-react"
import Link from "next/link"
import { useSearchParams } from "next/navigation"

function PartnerOrderConfirmationContent() {
    ...
    <div className="min-h-screen bg-gradient-to-br from-green-50 to-emerald-50 py-8">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Partner Order Confirmed!</h1>
          ...
          <Badge className="bg-green-100 text-green-800 text-sm mt-2">
            ...
            Partner Order - 15% Discount Applied
          </Badge>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="flex justify-between">
                <span className="text-gray-600">Partner Discount</span>
                <span className="font-medium text-green-600">15% Applied</span>
              </div>
            </CardContent>
          </Card>
          ...
          <CardContent className="p-6">
            <div className="flex items-start space-x-3">
              ...
              <div className="flex-1">
                <h3 className="font-medium text-green-900 mb-2">Partner Benefits</h3>
                <ul className="text-sm text-green-800 space-y-1">
                  <li>• 15% discount automatically applied</li>
                  <li>• Priority processing for partner orders</li>
...
export default function PartnerOrderConfirmationPage() {
  return (
    <Suspense fallback={
      <div className="min-h-screen bg-gradient-to-br from-green-50 to-emerald-50 py-8 flex items-center justify-center">
        <div className="text-center">
      ...
      <PartnerOrderConfirmationContent />
    </Suspense>
  )
}