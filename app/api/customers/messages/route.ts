...
// =====================================================
// Manages customer inbox messages
 ...
 * Fetch customer's inbox messages
 *
 * Query params:
...
export async function GET(request: NextRequest) {
  try {
    ...
    if (messagesError) {
      console.error('Failed to fetch customer messages:', messagesError);
      return NextResponse.json(
