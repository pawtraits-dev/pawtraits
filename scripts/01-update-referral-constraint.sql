-- Step 1: Update referral status constraint for clean database
-- Run this first after clearing test data
...
-- Update the create_referral_for_partner function to use 'invited'
...
SELECT 'Referral status constraint updated successfully!' as message;