-- Step 2: Add referral status transition functions
-- Run this second after updating the constraint
...
SELECT 'Referral status transition functions added successfully!' as message;