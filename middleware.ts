...
function addSecurityHeaders(response: NextResponse, request: NextRequest): void {
  ...
  const csp = [
    ...
    "connect-src 'self' https://api.stripe.com https://upload.stripe.com https://*.supabase.co wss://*.supabase.co https://api.anthropic.com https://api.cloudinary.com https://vercel.live wss://ws-us3.pusher.com",
