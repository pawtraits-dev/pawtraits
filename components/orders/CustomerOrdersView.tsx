...
export default function CustomerOrdersView({ userProfile }: CustomerOrdersViewProps) {
  ...
  const loadOrders = async () => {
    try {
      ...
      console.log('🛍️ CUSTOMER ORDERS: Loading orders via API');
...
// ✅ Customer-specific styling and routes